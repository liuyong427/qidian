    ...
    <div class="light-wrapper">
      <div class="fullscreenbanner-container revolution">
        <div class="fullscreenbanner">
          <ul>
            <li data-transition="fade"> <img src="/Public/images/art/slider-bg1.jpg" alt="" />
              ...
              <div class="caption small sfb" data-x="center" data-y="362" data-speed="900" data-start="2200" data-easing="Sine.easeOut">
                <div class="smooth"><a href="#portfolio" class="btn btn-border">查看系统</a></div>
              </div>
            </li>
            <li data-transition="fade"> <img src="/Public/images/art/slider-bg2.jpg" alt="" />
              <div class="caption large customin customout" data-x="center" data-y="255" data-customin="x:0;y:0;z:0;rotationX:90;rotationY:0;rotationZ:0;scaleX:1;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:200;transformOrigin:50% 0%;"
						...
						data-endspeed="300"
						data-endeasing="Power1.easeIn">呼叫中心一体机</div>
            ...
            <li data-transition="fade"> <img src="/Public/images/art/slider-bg3.jpg" alt="" />
          ...
          <ul class="content-slider items">
            ...
            <li class="item thumb photo">
              <figure><a href="#" data-contenturl="portfolio-post5.html" data-callback="callPortfolioScripts();" data-contentcontainer=".pcw">
                ...
                <img src="/Public/images/art/p13.jpg" alt="" /> </a></figure>
            </li>
            <li class="item thumb graphic">
              <figure><a href="#" data-contenturl="portfolio-post6.html" data-callback="callPortfolioScripts();" data-contentcontainer=".pcw">
                <div class="text-overlay">
                ...
                <img src="/Public/images/art/p14.jpg" alt="" /> </a></figure>
            </li>
            <li class="item thumb web">
              <figure><a href="#" data-contenturl="portfolio-post7.html" data-callback="callPortfolioScripts();" data-contentcontainer=".pcw">
                <div class="text-overlay">
                ...
                <img src="/Public/images/art/p15.jpg" alt="" /> </a></figure>
            </li>
          </ul>
          <!-- /.items --> 
        </div>
    ...
    <div class="light-wrapper">
      <div class="container inner">
        ...
        <div class="row">
          <div class="col-sm-8">
            <h2>公司简介</h2>
            <p>成都启点科技有限公司，由从事通信研发近十年的资深技术人员组成，专业从事新一代IP通信产品和企业融合通信系统研发、生产和销售，致力于为政府和企业提供先进、智能的融合通信一体化解决方案。</p>
            <p>我们兼收并蓄通讯技术及企业管理实践经验，立足于自主知识产权产品，是为了满足企事业用户对通讯业务日益多样化、高集成化的需求。目前已开发的产品有：数字程控交换机IPPBX、呼叫中心系统、电话营销CRM、电话会议系统、网络电子传真群发系统、语音催费查询系统等。</p>      
              ...
              <fieldset>
                <ol class="row">
                  <li class="form-row text-input-row name-field col-sm-6">
                    <input type="text" name="name" class="text-input defaultText required" title="姓名(必须)"/>
                  </li>
                  ...
                  <li class="form-row text-area-row col-sm-12">
                    <textarea name="message" class="text-area required" title="你的信息"></textarea>
                  </li>
                  ...
                  <li class="button-row">
                    <input type="submit" value="提交信息" name="submit" class="btn btn-submit bm0" />
                  </li>
                </ol>
