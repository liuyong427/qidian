...
#onlineService,.onlineMenu,.btmbg{background:url(Public/images/float_bg.gif) no-repeat;}
...
#onlineService #onlineMenu, #onlineService ul{margin-bottom:0px;padding:0px;}
#onlineService li{list-style-type:none;}
...
.wyzx{padding:8px 0 0 5px;height:57px;overflow:hidden;background:url(Public/images/webZx_bg.jpg) no-repeat;}
...
<div id="online_qq_layer">
	...
	<div id="onlineService">
		<div class="onlineMenu" style="">
			<h3 class="tQQ">QQ在线客服</h3>
			<ul>
				<li class="tli zixun">销售咨询</li>
				<li>
				<a href="javascript:void(0)">
				    <img  style="CURSOR: pointer" onclick="javascript:window.open('http://b.qq.com/webc.htm?new=0&sid=422143773&o=cdqidian.com&q=7', '_blank', 'height=502, width=644,toolbar=no,scrollbars=no,menubar=no,status=no');"  border="0" SRC=http://wpa.qq.com/pa?p=1:422143773:1 alt="点击这里给我发消息">
				</a>
				</li>
				<li class="tli fufei">技术咨询</li>
				<li class="last"><a href="javascript:void(0)"><img src="/Public/images/pa.gif" width="74" height="22" alt="客服001" /></a></li>
			</ul>
		</div>
		
		<div class="onlineMenu">
			<h3 class="tele">电话咨询</h3>
			<ul>
				<li class="tli phone"><a href="tel:02869686996">02869686996</a></li>
			</ul>
		</div>
		<div class="btmbg"></div>
	</div>
