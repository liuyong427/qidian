...
<!-- TopMain -->
<div id="TopMain">
<form method="post" action="/tp/qidian/admin.php/News/index">
...
<span><a class="btn btn-info mleft50" href="/tp/qidian/admin.php/News/edit" role="button">添加</a></span>
</div>
<!-- /TopMain -->
...
<td><a href="/tp/qidian/admin.php/News/edit/id/<?php echo ($vo["id"]); ?>">编辑</a> | <a href="/tp/qidian/admin.php/News/del/id/<?php echo ($vo["id"]); ?>">删除</a></td>
