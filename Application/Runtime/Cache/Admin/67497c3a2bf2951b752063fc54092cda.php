...
<td><?php if(($vo["id"]) == $_SESSION['userid']): echo (session('last_login')); else: echo ($vo["last_login"]); endif; ?></td>
<td><?php echo ($vo["ip"]); ?></td>
<td><a href="/admin.php/Users/edit/id/<?php echo ($vo["id"]); ?>">编辑</a> | <a href="/admin.php/Users/del/id/<?php echo ($vo["id"]); ?>" onclick="return confirm('你确定删除')">删除</a></td>
